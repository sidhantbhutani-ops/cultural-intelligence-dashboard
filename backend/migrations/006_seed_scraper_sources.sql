...
('Variety', 'news', 'https://variety.com', 'api', 'views', 50, 1, 'Entertainment and culture', true);

INSERT INTO scraper_sources (name, source_type, base_url, scrape_strategy, engagement_metric, rate_limit_per_hour, priority, description, is_active) VALUES
('Rolling Stone', 'news', 'https://rollingstone.com', 'api', 'views', 50, 1, 'Music and pop culture', true);

INSERT INTO scraper_sources (name, source_type, base_url, scrape_strategy, engagement_metric, rate_limit_per_hour, priority, description, is_active) VALUES
('WIRED', 'news', 'https://wired.com', 'api', 'views', 50, 1, 'Technology and culture', true);
